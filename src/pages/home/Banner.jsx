...
// const Banner = () => {
//   return (
//     <div className='flex flex-col md:flex-row-reverse py-16 justify-between item-center gap-12 container mx-auto'>

//          <div className='md-w-1/2 w-full flex item-center justify-end'>
